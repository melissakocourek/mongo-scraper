...
router.get("/saved-articles", function(req, res) {
    ...
    .then(function(savedData) {
        ...
        //send all found saved articles as an object to be used in the handlebars section of the index.
...
router.get("/getnotes/:id", function(req,res) {
    ...
    .catch(function(error) {
        // If an error occurs, send the error to the clinet.
        res.json(error);
    });
});
...
router.put("/returned/:id", function(req, res) {
    ...
    .catch(function(error) {
        // If any error occurs, send the error to the client.
        res.json(error)
    });
});
